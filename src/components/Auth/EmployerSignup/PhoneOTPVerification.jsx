  ...
  return (
    <div className="p-6 bg-blue-50 border border-blue-200 rounded-lg">
      <div className="flex items-center gap-2 mb-4">
        <PhoneIcon className="text-blue-600" sx={{ fontSize: 20 }} />
      ...
      <div className="flex gap-2 mb-4" onPaste={handlePaste}>
        {otp.map((digit, index) => (
          <input
            ...
            className="w-10 h-10 text-center text-lg font-semibold border-2 border-slate-300 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all"
            autoFocus={index === 0}
          />
        ))}
      </div>
...
PhoneOTPVerification.propTypes = {
